...
export const users = pgTable("users", {
  ...
  hasUnlockedFirstReport: boolean("has_unlocked_first_report").default(false).notNull(), // Whether user has paid for their first report ($9.99)
...
export const quizAttempts = pgTable("quiz_attempts", {
  ...
  isPaid: boolean("is_paid").default(false).notNull(), // Whether this specific quiz attempt has been paid for
